...
data _null_;
  ...
  format from_datetime datetime20.;
  to_time       = %convert_timezone(from_datetime,edt,mdt);
  format to_time datetime20.;
  put from_datetime= to_time=;
run;

data _null_;
  atlanta_datetime = datetime();
  german_datetime = %convert_timezone(atlanta_datetime,est,eet);
  putlog atlanta_datetime= datetime20.;
  putlog german_datetime= datetime20.;
run;
