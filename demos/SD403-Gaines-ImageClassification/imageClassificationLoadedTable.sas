...
/*                                                                              */
/* Description:                                                                 */
/*    This is an alternative version of the code that assumes your images are   */
/*    already in an in-memory table, which you can accomplish by using the      */
/*    Load Images task.  This code continues the analytics life cycle in the    */
/*    exploration phase and continues through the creation of an analytic store */
/*    that you can use to put the model into production.                        */
/*                                                                              */
/* Notes:                                                                       */
...
/* Specify the caslib and table name to use for the augmented training image data table */
...
/* Connect to a CAS server and automatically assign librefs */
/* cas; */
/* caslib _all_ assign; */
